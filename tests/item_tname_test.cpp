...
TEST_CASE( "activity_reserved_item_tname", "[item][tname][activity]" )
{
    item reserved( itype_rock );

    reserved.set_var( "activity_var", "Camp worker" );
    CHECK( reserved.tname() == "rock (in use)" );

    reserved.erase_var( "activity_var" );
    CHECK( reserved.tname() == "rock" );
}
