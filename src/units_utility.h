...
// Convert an angle to 0=north, 1=west, 2=south, 3=east.  Vehicle tiles use
// these four indices instead of raw degrees.
int angle_to_dir4( units::angle direction );

// Convert an angle to 0=north, 1=north-west, 2=west, and so on.
