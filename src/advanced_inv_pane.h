...
class advanced_inventory_pane
{
    ...
    public:
        ...
        /**
         * Restore the pane-local container and return a safe area to display.
         * Missing or stale containers fall back to their former area, or AIM_ALL
         * when no usable former area was saved.
         */
