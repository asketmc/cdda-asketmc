...
void options_manager::add_options_general()
{
    ...
    add( "FORCE_SMART_CONTROLLER_OFF_ON_ENGINE_STOP", "general",
         ...
         to_translation( "Controls what happens when you manually stop the engine of a vehicle whose smart controller could restart its single combustion engine." ),
    {
...
void options_manager::add_options_graphics()
{
    ...
    add( "FONT_HINTING", "graphics", to_translation( "Font hinting" ),
         to_translation( "Controls how TrueType glyphs align to the pixel grid.  Requires restart." ),
    {   { "normal", to_translation( "Normal" ) },
        { "light", to_translation( "Light" ) },
        { "mono", to_translation( "Monochrome" ) },
        { "none", to_translation( "None" ) }
    },
