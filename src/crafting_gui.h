...
std::pair<Character *, const recipe *> select_crafter_and_crafting_recipe( int &batch_size_out,
        ...
        bool camp_crafting = false, const inventory *inventory_override = nullptr,
        const recipe_subset *recipes_override = nullptr );

const recipe *select_crafting_recipe( int &batch_size_out, const recipe_id &goto_recipe,
                                      Character *crafter = nullptr, bool camp_crafting = false,
                                      const inventory *inventory_override = nullptr,
                                      const recipe_subset *recipes_override = nullptr );
