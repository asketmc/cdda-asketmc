...
class overmapbuffer
{
    public:
        ...
        /** Add a camp and return the inserted overmap-owned instance. */
        basecamp &add_camp( const basecamp &camp );

        /** Return the positions of every camp in an overmap currently in memory. */
        std::vector<tripoint_abs_omt> get_loaded_camp_locations() const;
