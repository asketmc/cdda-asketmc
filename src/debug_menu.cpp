    ...
    switch( nmenu.ret ) {
        ...
        case D_ITEM_WORN: {
            ...
            if( to_wear.is_armor() ) {
                ...
                cata::event event = cata::event::make<event_type::character_wields_item>( you.getID(),
                                    wielded->typeId() );
                get_event_bus().send_with_talker( &you, &wielded, event );
            }
        }
        break;
        case D_HP:
    ...
    switch( *action ) {
        ...
        case debug_menu_index::VEHICLE_EXPORT: {
            if( optional_vpart_position ovp = here.veh_at( player_character.pos() ) ) {
                ...
                const std::string text = string_input_popup()
                                         ...
                                         .width( 20 )
                                         .query_string();
                const cata_path veh_path = export_dir / ( text + ".json" );
                try {
        ...
        case debug_menu_index::EDIT_CAMP_LARDER: {
            ...
            if( query_int( larder, _( "Set camp larder kCals to?  Currently: %d" ),
                           your_faction->food_supply.kcal() ) ) {
                your_faction->food_supply.calories = larder * 1000;
            }
            break;
        }
        ...
        case debug_menu_index::EXPORT_FOLLOWER: {
            ...
            try {
                ...
                debugmsg( _( "Failed to export NPC: %s" ), err.what() );
            }
            break;
        }
        ...
        case debug_menu_index::EXPORT_SELF: {
            ...
            try {
                ...
                debugmsg( _( "Failed to export avatar: %s" ), err.what() );
            }
            break;
        }
