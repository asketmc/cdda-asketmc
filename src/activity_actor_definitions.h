...
class hacksaw_activity_actor : public activity_actor
{
    ...
    private:
        tripoint target;
        item_location tool;
        cata::optional<itype_id> type;
        cata::optional<tripoint> veh_pos;
...
class ebooksave_activity_actor : public activity_actor
{
    ...
    private:
        ...
        */
        ...
        void completed_scanning_current_book( Character &who );
};
...
class move_furniture_activity_actor : public activity_actor
{
    ...
    public:
        move_furniture_activity_actor( const tripoint &dp, bool via_ramp, bool on_vehicle = false ) :
            dp( dp ), via_ramp( via_ramp ), on_vehicle( on_vehicle ) {}
        activity_id get_type() const override {
        ...
        bool can_move_furniture_on_vehicle_to( map &here, const tripoint &dest ) const;
        // Returns false when the player should move with the furniture.
        bool move_furniture_on_vehicle( Character &who ) const;
