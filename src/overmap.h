...
class overmap
{
    ...
    public:
        static void load_camp_migration( const JsonObject &jo );
        static void reset_camp_migrations();
        static bool terrain_should_have_camp( const oter_type_str_id &terrain );
