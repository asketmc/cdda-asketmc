...
struct mut_transform {
    ...
    int moves = 0;
    /** If true, transform through normal mutation prerequisites and conflict handling. */
    bool safe = false;
    mut_transform();
...
struct mutation_branch {
        ...
        /** effect_on_conditions triggered while this mutation remains active */
        ...
        /** activation EOCs initialize a persistent powered mutation instead of a one-shot effect */
