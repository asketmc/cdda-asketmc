...
/**
 * Store liquids produced by an NPC activity in nearby containers.  If no
 * suitable container is available, the remainder is spilled at the NPC's feet.
 * This does not consume moves; the producing activity has already paid that cost.
 */
