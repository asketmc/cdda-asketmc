...
class game
{
    ...
    public:
        ...
        * @param change_lv whether the cursor may change z-level
        ...
        */
        ...
        // Tiles: equivalent to draw_cursor.  Curses: draws diagonal arrows around
        // the target so the selected vehicle tile remains visible.
        void draw_cursor_unobscuring( const tripoint &p ) const;
    ...
    private:
        ...
        bool grabbed_veh_move_stairs( const tripoint &dp );
