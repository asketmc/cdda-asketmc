...
struct veh_menu_item {
    ...
    std::string _desc;
    int _symbol = 0;
    nc_color _symbol_color = c_light_gray;
    nc_color _text_color = c_light_gray;
    ...
    veh_menu_item &hotkey( const input_event &event );
...
class veh_menu
{
    public:
        ...
        void sort( const std::function<bool( const veh_menu_item &, const veh_menu_item & )> &comparer );
    ...
    private:
        ...
        cata::optional<int> last_selected = cata::nullopt;
};
