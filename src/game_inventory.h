...
/** Choose an empty compatible tool to attach to a modular vehicle station. */
item_location veh_tool_attach( Character &you, const std::string &part_name,
...
/** Bionic install menu where the installer and the character supplying the CBM differ. */
