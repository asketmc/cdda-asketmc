...
class Character : public Creature, public visitable
{
    ...
    public:
        ...
        /** Unset switched mutation and set target mutation instead; safe transforms follow normal mutation rules. */
        bool switch_mutations( const trait_id &switched, const trait_id &target, bool start_powered,
                               bool safe = false );
    ...
    public:
        ...
        */
        ...
        /** Apply the painful start of an improvised operation without allowing that pain to cancel it. */
        void apply_manual_bionic_installation_pain( int difficulty );
        ...
        */
         ...
         * @param penalties Whether item volume and temporary effects (e.g. GRABBED, DOWNED) should be considered.
         * @param base_cost Cost due to storage type.
         * @param charges_in_it Number of charges handled, or all charges when negative.
         * @param bulk_cost Exclude per-operation hand-encumbrance overhead for a
         * sequence of items handled from the same source.
         * @return cost in moves ranging from 0 to MAX_HANDLING_COST
         */
        int item_handling_cost( const item &it, bool penalties = true,
                                int base_cost = INVENTORY_HANDLING_PENALTY,
                                int charges_in_it = -1, bool bulk_cost = false ) const;
        ...
        */
        ...
        /** Effective practical level including progress toward the next level.
         * Integer requirement checks must continue to use get_skill_level(). */
        float get_skill_level_with_progress( const skill_id &ident ) const;
        float get_skill_level_with_progress( const skill_id &ident, const item &context ) const;
    ...
    public:
        ...
        * */
        ...
        /** Exact chance that the unchanged 0.G crafting roll is below 1.0. */
        double crafting_failure_chance( const recipe &making ) const;
