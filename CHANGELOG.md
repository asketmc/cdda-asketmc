...
## CDDA 0.G Additive 2026.08.29.2
...
- [PR #30](https://github.com/asketmc/cdda-asketmc/pull/30): Release workflow ordering fix only; no player-facing behavior changed.
- [PR #31](https://github.com/asketmc/cdda-asketmc/pull/31): Release metadata only; player changes are recorded in their source pull requests.
