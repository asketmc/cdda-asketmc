...
| Supported ledge descent | Adapted for 0.G | [BN #2879](https://github.com/cataclysmbnteam/Cataclysm-BN/pull/2879), selected logic from [DDA #68120](https://github.com/CleverRaven/Cataclysm-DDA/pull/68120) and [DDA #68190](https://github.com/CleverRaven/Cataclysm-DDA/pull/68190); unsupported drops and existing climbing tools remain unchanged; the modern climbing JSON framework is excluded |
