...
| Faster dissection factors | Adapted for 0.G | [BN #6146](https://github.com/cataclysmbn/Cataclysm-BN/pull/6146), squash `9a6071df66c2e6bb16a737f53811c1caac993372`; the dissection-only First Aid, PER/DEX, fine-cutting, and three-helper factors are retained while the incompatible global activity-engine rewrite is excluded |
| Bulk and follower dissection | Adapted with save/load recovery | [BN #9212](https://github.com/cataclysmbn/Cataclysm-BN/pull/9212), head `1fe9f6d8f0ae3a7884c28de9db95339720a5ea2f`; uses a non-conflicting menu bit/key, actor-aware CBM messages, and resumes the multi activity if a saved corpse target vanished |
| Activity reality-bubble resizing | Not imported; prerequisite-incompatible | [BN #8361](https://github.com/cataclysmbn/Cataclysm-BN/pull/8361) depends on BN #8252's runtime-sized map/cache overhaul; 0.G retains compile-time `MAPSIZE`, so a partial transplant would corrupt size-dependent caches |
