...
- ```FURNITURE_LIFT_ASSIST``` Adds 5 effective strength when loading furniture. Requires `FURNITURE_TIEDOWN`.
- ```FURNITURE_TIEDOWN``` Allows furniture to be loaded and tied down. Requires `CARGO`.
