...
* completion_eoc: an activation EOC that is run when this activity completes.  If it cancels or replaces the activity, the replacement is not finished in the same turn.

* do_turn_eoc: an activation EOC that is run when this activity performs a turn
